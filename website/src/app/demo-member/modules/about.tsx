  ...
  return (
    <div>
      ...
      <ul className="tech_stack">
        ...
        <li><b>Deployment</b>: Frontend is hosted on <a href="https://vercel.com/" target="_blank">Vercel</a>. Backend, PostgreSQL and Valkey are hosted on a Linux virtual machine, containerized and deployed using <a href="https://podman.io/" target="_blank">Podman</a>.</li>
      </ul>
    </div>
  );
}
